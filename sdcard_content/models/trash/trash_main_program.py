...
while(True):
    ...
    if op_mode==0:
        ...
        while(True):
            ...
            if (btn_trigger or ts_trigger) and img_logging:
        ...
        if (btn_trigger or ts_trigger) and not pause and not first_cycle:
            pause = True
		...
		# Divide element wise with value
		#[x/2 for x in vec]
